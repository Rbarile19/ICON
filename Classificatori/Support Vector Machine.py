...
model_params = {
    ...
    'kernel': 'rbf',  # Usare il kernel RBF
    'gamma': 'scale'  # Coefficiente gamma per il kernel RBF
}
...
for fold, (train_idx, test_idx) in enumerate(skf.split(X_scaled, y)):
    ...
    # Definizione del modello SVM con iperparametri fissi
    model = SVC(C=model_params['C'], kernel=model_params['kernel'], gamma=model_params['gamma'], random_state=42)
