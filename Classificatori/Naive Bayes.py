...
# Inizializziamo StratifiedKFold per mantenere la distribuzione delle classi tra i fold
...
# Impostazione degli iperparametri di GaussianNB
var_smoothing = 1e-9
...
for fold, (train_idx, test_idx) in enumerate(skf.split(X_scaled, y)):
    ...
    # Definizione del modello Naive Bayes (GaussianNB) con iperparametri
    bayes = GaussianNB(var_smoothing=var_smoothing)
