...
# Impostazione degli iperparametri del modello XGBoost
xgb_params = {
    'n_estimators': 100,         # Numero di alberi
    'max_depth': 4,              # Profondità massima degli alberi
    'learning_rate': 0.1,        # Tasso di apprendimento
    'scale_pos_weight': 1,       # Gestione dello sbilanciamento delle classi
    'random_state': 42,          # Fissiamo il seed per la riproducibilità
    'use_label_encoder': False,  # Per evitare avvisi con le ultime versioni di XGBoost
    'eval_metric': 'logloss'     # Metodologia di valutazione
}
...
for fold, (train_idx, test_idx) in enumerate(skf.split(X_scaled, y)):
    ...
    # Definizione del modello XGBoost con gli iperparametri definiti
